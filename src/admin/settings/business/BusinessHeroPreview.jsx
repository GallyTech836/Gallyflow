...
export default function BusinessHeroPreview({ config }) {
  return (
    <div className="bg-nexus-surface border border-nexus-border rounded-2xl overflow-hidden">
      ...
      <div className="bg-nexus-background relative overflow-hidden min-h-[380px] flex items-center justify-center p-8">
        {/* Glows decorativos idénticos a ClienteApp */}
        <div className="absolute top-[-30%] left-[-20%] w-[70%] h-[70%] bg-nexus-primary/5 blur-[100px] rounded-full pointer-events-none" />
        <div className="absolute bottom-[-20%] right-[-15%] w-[50%] h-[50%] bg-nexus-primary/5 blur-[110px] rounded-full pointer-events-none" />
